...
const InformationCV3 = () => {
    ...
    const [award1Company, setAward1Company] = useState("")
    const [award3Company, setAward3Company] = useState("")
    const [award2Company, setAward2Company] = useState("")
    ...
    const submit = (e: any) => {
        if (!name || !mobileNumber || !email || !educationHighSchool || !experience1 || !currentWorkPost || !personalStatement ) {
        ...
        <React.Fragment>
            ...
            {!formSubmitted ?
                <>
                    <div>
                        <Form style={{ margin: '1%', padding: "0.5%" }}>
                            <Form.Group className="mb-2" controlId="formGeneralInformation">
                                ...
                                <Form.Label style={{ color: 'darkblue' }}>Enter  Personal Statement</Form.Label>
                                <Form.Control className="mb-2" type="text" value={personalStatement} onChange={event => setPersonalStatement(event.target.value)}
                                ...
                                <Container style={{ padding: "0.5%" }}>
                                    ...
                                    <Row>
                                        ...
                                        <Col lg >
                                            <Form.Group controlId="formBasicEmail">
                                                <Form.Label style={{ color: 'darkblue' }}>Enter your Facebook Id</Form.Label>
                                                <Form.Control className="mb-2" type="email" value={facebook} onChange={event => setFacebook(event.target.value)} placeholder="Enter your e-mail address" />
                                            </Form.Group>
                                        </Col>
                                        <Col lg >
                                            <Form.Group controlId="formBasicEmail">
                    ...
                    <div style={{ margin: '1%', padding: "0.5%" }}>
                        ...
                        <Form >
                            ...
                            <Form.Group className="mb-2" controlId="exampleForm.ControlTextarea1">
                                <h4> <Form.Label style={{ color: 'darkblue' }}>Awards</Form.Label></h4>
                                <h5><Form.Label style={{ color: 'darkblue' }}>Award 1</Form.Label></h5>
                                <Row>
                                    <Col>
                                        <Form.Label style={{ color: 'darkblue' }}>Award 1 Title</Form.Label>
                                        <Form.Control as="textarea" value={award1Title} onChange={event => setAward1Title(event.target.value)} rows={2} />
                                    </Col>
                                    <Col>
                                    <Form.Label style={{ color: 'darkblue' }}>Award 1 Company</Form.Label>
                                        <Form.Control as="textarea" value={award1Company} onChange={event => setAward1Company(event.target.value)} rows={2} />
                                    </Col>

                                </Row>
                                <Row>
                                <Form.Label style={{ color: 'darkblue' }}>Award 1 Description</Form.Label>
                                        <Form.Control as="textarea" value={award1} onChange={event => setAward1(event.target.value)} rows={2} />
                                </Row>
                                
                                <h5><Form.Label style={{ color: 'darkblue' }}>Award 2</Form.Label></h5>
                                <Row>
                                    <Col>
                                        <Form.Label style={{ color: 'darkblue' }}>Award 2 Title</Form.Label>
                                        <Form.Control as="textarea" value={award2Title} onChange={event => setAward2Title(event.target.value)} rows={2} />
                                    </Col>
                                    <Col>
                                    <Form.Label style={{ color: 'darkblue' }}>Award 2 Company</Form.Label>
                                        <Form.Control as="textarea" value={award2Company} onChange={event => setAward2Company(event.target.value)} rows={2} />
                                    </Col>

                                </Row>
                                <Row>
                                <Form.Label style={{ color: 'darkblue' }}>Award 2 Description</Form.Label>
                                        <Form.Control as="textarea" value={award2} onChange={event => setAward2(event.target.value)} rows={2} />
                                </Row>
                                <h5><Form.Label style={{ color: 'darkblue' }}>Award 3</Form.Label></h5>
                                <Row>
                                    <Col>
                                        <Form.Label style={{ color: 'darkblue' }}>Award 3 Title</Form.Label>
                                        <Form.Control as="textarea" value={award3Title} onChange={event => setAward3Title(event.target.value)} rows={2} />
                                    </Col>
                                    <Col>
                                    <Form.Label style={{ color: 'darkblue' }}>Award 3 Company</Form.Label>
                                        <Form.Control as="textarea" value={award3Company} onChange={event => setAward3Company(event.target.value)} rows={2} />
                                    </Col>

                                </Row>
                                <Row>
                                <Form.Label style={{ color: 'darkblue' }}>Award 3 Description</Form.Label>
                                        <Form.Control as="textarea" value={award3} onChange={event => setAward3(event.target.value)} rows={2} />
                                </Row>
                            </Form.Group>
                        </Form>
                        <Form >
                ...
                : <CV3
                    ...
                    award1Company={award1Company}
                    award3Company={award3Company}
                    award2Company={award2Company}
                    facebook={facebook}
                    github={github}
                    linkedIn={linkedIn}
                    twitter={twitter}
